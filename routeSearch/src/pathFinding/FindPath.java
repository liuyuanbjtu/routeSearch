...
public class FindPath {
    ...
    public void findAccessPathAll(String time)
    {
    		...
    		for(int indexD=0;indexD<stationNum;indexD++)
		{
    			...
    			{
    			computeForwardPaths(time,network.stations[indexO].stationName, network.stations[indexD].stationName);
    	...
    	System.out.println("find 1-All paths:"+this.countPath);
    ...
    public  void computeForwardPaths(long time,String OriginalS,String DestinationS)
    {
		...
		{
			computeForwardPath(time,OriginalS,DestinationS,type);
		}
    ...
    public  void computeForwardPaths(String timeStr,String OriginalS,String DestinationS)
    {
		long time=0;
    	try
        {
    ...
    public  void computeForwardPaths(String timeStr, String timeStr2,String OriginalS,String DestinationS)
    {
		long time=0;
		long time2=0;
    	try
    	...
    	do
    	{
    		this.computeForwardPaths(time-1, OriginalS, DestinationS);
    		System.out.println("count:"+count+"time:"+time+"time2:"+time2);
    		count++;
	...
	public  void computeForwardPath(long time,String OriginalS,String DestinationS,int type)
    {
	   ...
	   private void insertB(Node node, int type)
	    ...
	    public void WriteAccessRoutes(String time,String stationO, String stationD,int style)
		{
				...
				try{
					String filePath="";
						filePath="Data\\AccessRoutesingle.txt";
